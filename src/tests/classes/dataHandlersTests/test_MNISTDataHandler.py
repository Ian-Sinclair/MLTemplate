...
class TestMnistDataHandler(unittest.TestCase):
    ...
    @patch('src.main.classes.projectUtils.DirectoryUtil.isValidDirectory', return_value=True)
    ...
    @patch('src.main.classes.projectUtils.DirectoryUtil.isValidFile', return_value=True)
